const reactivateAccountEmailTemplate = function (email: string) {
                        ...
                        <tr>
                          <td>
                            <p
                              ...
                              "
                            >
                            Your Slyft account was reactivated
                            </p>
                            ...
                            <p
                              ...
                              "
                            >
                            We're just confirming that the spotify account registered with the email address ${email} was recently reactivated.
                            </p>
                          ...
                          style="
                            ...
                            margin-bottom: 1.5rem;
                            color: rgb(23, 24, 28);
                          ">If it wasn't you who reactivated the account, contact Slyft customer support.</p>
                            <p
                              data-id="react-email-text"
                              style="
                                font-size: 0.875rem;
  ...
  const subject = "Slyft account reactivated";
...
export default reactivateAccountEmailTemplate;
