const closeAccountEmailTemplate = function (
  firstname: string,
  url: string,
  timeframe: string
) {
                      ...
                      <tr>
                        <td>
                          ...
                          <p
                            ...
                            "
                          >
                          Your Slyft account is now closed.
                          </p>
                        ...
                        style="
                          ...
                          margin-bottom: 1.5rem;
                          color: rgb(23, 24, 28);
                        ">You can reactivate it within the next ${timeframe} days by clicking the button below. After ${timeframe} days, your account cannot be reactivated and the process to delete your data will be initiated. You are always welcome to create a new one</p>
                        ...
                        style="
                          ...
                          margin-bottom: 1.5rem;
                          color: rgb(23, 24, 28);
                        ">If we don't see you again, we wish you a fond farewell</p>
                          <p
                            data-id="react-email-text"
                            style="
                              font-size: 0.875rem;
                  ...
                  >
                    <tbody>
                      <tr>
                        ...
                        "
                      >
                      You received this email because you've requested to close your account.
  ...
  const subject = "Account Closure Completed";
...
export default closeAccountEmailTemplate;
