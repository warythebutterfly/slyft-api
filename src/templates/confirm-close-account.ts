const confirmCloseAccountEmailTemplate = function (
  firstname: string,
  url: string,
  timeframe: string
) {
  const html = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        <html lang="en">
          ...
          <div
            ...
            "
          >
            Please confirm you want to close your Slyft account
            <div>
               ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏  ‌ ‍‎‏ 
            </div>
          </div>
                        ...
                        <tr>
                          <td>
                            ...
                            <p
                              ...
                              "
                            >
                           Please click the button below within 24 hours to close your Slyft account.
                            </p>
                          ...
                          style="
                            ...
                            margin-bottom: 1.5rem;
                            color: rgb(23, 24, 28);
                          ">We'll then send you a confirmation email with a link to reactivate the account if you need to. This will be valid for ${timeframe} days. After those ${timeframe} days, your account can no longer be reactivated.</p>
                            <p
                              data-id="react-email-text"
                              style="
                                font-size: 0.875rem;
                    ...
                    >
                      <tbody>
                        <tr>
                          ...
                          "
                        >
                        You received this email because you've requested to close your account. If you no longer wish to close your account, you can simply ignore this email.
  ...
  const subject = " Please confirm you want to close your Slyft account";
...
export default confirmCloseAccountEmailTemplate;
