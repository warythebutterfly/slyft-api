const passwordResetSuccessEmailTemplate = function (firstname: string) {
                    ...
                    <tr>
                      <td>
                        ...
                        <p
                          ...
                          "
                        >
                        Your Slyft account password has been successfully reset.
                        </p>
                        <p
                          data-id="react-email-text"
                          style="
                    ...
                    <tr>
                      <td>
                        <p
                          ...
                          "
                        >
                        If you have any concerns or did not initiate this password reset, please contact our support team immediately.
                        </p>
                        <p
                        data-id="react-email-text"
                        style="
  ...
  const subject = "Password Reset Successful - Slyft";
